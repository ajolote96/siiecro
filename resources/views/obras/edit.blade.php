...
<form action="{{ route('Obras.actualizar', $obra->id) }}" method="POST" class="form-inline text-left">
    ...
    @csrf
            ...
            <div class="input-group" >
                ...
                <input type="text" name="sector_obra" value="{{ $obra->sector_obra}}" class="form-control" style="width:200px">
                 </div>
            ...
            <div class="input-group" >
                ...
                <input type="text" name="temporada_trabajo" value="{{ $obra->temporada_trabajo}}" class="form-control" style="width:200px">  
                 </div>
            @endpermission
