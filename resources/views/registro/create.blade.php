                ...
                <form action="{{ route('RegistroCientifico.store') }}" method="POST" class="form-inline text-left" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <div class="form-group">
                            ...
                            <div class="input-group" >
                                ...
                                <input type="text" name="id_gene" class="form-control"  value="{{ $analisisg->id_general }}" style="width:200px" readonly><BR>    
                            </div>
                            <div class="input-group" >
                                <label for="id_obras" class="input-group-addon">ID Obra </label>
                                <input type="text" name="id_obras" class="form-control"  value="{{ $analisisg->id_obra }}" style="width:200px" readonly><BR>    
                            </div>
                            <div class="input-group" >
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" name="temp_trabajo" class="form-control"  value="{{ $analisisg->temp_obra }}" style="width:200px" readonly>
                            </div>
                            <div class="input-group ">
                                <label for="epoca_obra" class="input-group-addon">Epoca de la obra</label>
                                <input type="text" name="epoca" class="form-control"  value="{{ $analisisg->epoca_obra }}" style="width:200px" readonly>
                            </div>                            
                            <div class="input-group">
                                <label for="lugar_proce_ori" class="input-group-addon">Lugar de procedencia original</label>
                                <input type="text" class="form-control"  name="lugar_p_origen"  value="{{ $analisisg->lugar_proce_ori }}" style="width:200px"readonly>
                            </div>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                                ...
                                <input type="text" class="form-control"  name="lugar_p_actual"  value="{{ $analisisg->lugar_proce_act }}" style="width:200px" readonly>
                            </div>
                    <div class="input-group">
                        <label for="proyecto_ecro" class="input-group-addon">Proyecto de la obra</label>
                        <input type="text" class="form-control"  name="proyecto_ecro"  value="{{ $analisisg->proyecto_obra }}" style="width:200px" readonly>
                    </div>
                    <div class="input-group">
                        <label for="año_proyecto" class="input-group-addon">Año de proyecto de la obra</label>
                        <input type="text" class="form-control"  name="año_proyecto" value="{{ $analisisg->año_proyec_obra }}" style="width:200px" readonly>
                    </div>
                </div><br><br>
                    <div class="input-group">
                        ...
                        <input type="date" class="form-control date" name="fecha_inicio" placeholder="mm/dd/aaaa (Fecha de entrada)" value="{{ $analisisg->fecha_de_inicio }}" style="width:262px" readonly>
                    </div>
                    </div>
                    </div><br><br><br>
                    <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control"  name="tecnica" value="{{ $analisisg->tecnica }}" style="width:200px" readonly>
                    </div><br><br>
                    
                <div class="form-group">
                    <div class="input-group">
                        <label for="nomenclatura_muestra" class="input-group-addon">Nomenclatura de la muestra</label>
                        <input type="text" class="form-control"  name="nomenclatura_muestra" style="width:200px" >
                    </div> 
                    <div class="input-group">
                        <label for="lugar_de_resguardo" class="input-group-addon">Lugar de Resguardo</label>
                        <input type="text" class="form-control"  name="lugar_de_resguardo" style="width:200px" >
                    </div>
                    <div class="input-group">
                        <label for="caracte_analisis" class="input-group-addon">Caracterizacion de analisis</label>
                        <input type="text" class="form-control"  name="caracte_analisis" style="width:200px" >
                    </div> 
                    </div><br><br>
                    <div class="input-group date">
                        <div class="input-group-addon">
                        ...
                        <input type="date" class="form-control date" name="fecha_analisis_cientifico" style="width:262px">
                    </div> <br><br>  
                    <div class="form-group">
                    <div class="input-group">
                        <label for="profesor_responsable" class="input-group-addon">Profesor responsable</label>
                        <input type="text" class="form-control"  name="profesor_responsable" style="width:200px" >
                    </div> 
                    <div class="input-group">
                        <label for="persona_realizo_analisis" class="input-group-addon">Persona que realizo el analisis</label>
                        <input type="text" class="form-control"  name="persona_realizo_analisis" style="width:200px" >
                    </div> 
                    <div class="input-group">
                        <label for="forma_obtencion_muestra" class="input-group-addon">Forma de obtencion de las muestras</label>
                        <input type="text" class="form-control"  name="forma_obtencion_muestra" style="width:200px" >
                    </div> 
                    </div><br><br>
                    <div class="form-group">
                    <div class="input-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control"  name="indicaciones" style="width:200px" >
                    </div>      
                    </div><br><br>
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control"  name="tipo_material" style="width:200px" >
                    </div>
                    <div class="input-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control"  name="resultado_interpretacion">
                    </div>
                    <div class="input-group">
                        <label for="resultado_descripcion" class="input-group-addon">Resultados de Descripción</label>
                        <input type="text" class="form-control"  name="resultado_descripcion">
                    </div>
                    <div class="input-group">
                        <label for="resultado_conclucion_general" class="input-group-addon">Conclusión Generak</label>
                        <input type="text" class="form-control"  name="resultado_conclucion_general">
                    </div>
                    <div class="input-group">
                        <label for="interpretacion_particular" class="input-group-addon">Interpretación Particular</label>
                        <input type="text" class="form-control"  name="interpretacion_particular">
                    </div>
